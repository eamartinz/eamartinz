...
plt.tight_layout()
plt.savefig(str(MODELS_DIR / 'loss_plot.png'), dpi=300, bbox_inches='tight')
print(f"✓ Gráfico de Loss salvo: {MODELS_DIR / 'loss_plot.png'}")
plt.close()
...
plt.tight_layout()
plt.savefig(str(MODELS_DIR / 'accuracy_plot.png'), dpi=300, bbox_inches='tight')
print(f"✓ Gráfico de Acurácia salvo: {MODELS_DIR / 'accuracy_plot.png'}")
plt.close()
...
plt.tight_layout()
plt.savefig(str(MODELS_DIR / 'confusion_matrix.png'), dpi=300, bbox_inches='tight')
print(f"✓ Matriz de Confusão salvo: {MODELS_DIR / 'confusion_matrix.png'}")
plt.close()
...
plt.tight_layout()
plt.savefig(str(MODELS_DIR / 'training_metrics_combined.png'), dpi=300, bbox_inches='tight')
print(f"✓ Gráfico combinado salvo: {MODELS_DIR / 'training_metrics_combined.png'}")
plt.close()
...
print("  - loss_plot.png: Gráfico de Loss (Treino vs Validação)")
print("  - accuracy_plot.png: Gráfico de Acurácia (Treino vs Validação)")
print("  - confusion_matrix.png: Matriz de Confusão do Teste")
print("  - training_metrics_combined.png: Gráficos combinados")
